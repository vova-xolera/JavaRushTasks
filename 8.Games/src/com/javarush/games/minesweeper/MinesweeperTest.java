...
public class MinesweeperTest extends Game {
    ...
    private void gameOver() {
        isGameStopped = true;
        showMessageDialog(Color.RED, "Эх, Маша...", Color.AQUA, 50);
    }
    private void win() {
        isGameStopped = true;
        showMessageDialog(Color.GREEN, "Girls rule the world!!", Color.ORANGE, 50);
    }
